cask "ssh-config-editor-alt" do
  ...
  url "https://www.dropbox.com/s/mh49vwvue47au8a/SSH.Config.Editor.v2.3.2.dmg.zip?dl=1",
      user_agent: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.13; rv:59.0) Gecko/20100101 Firefox/59.0",
      referer: "https://www.dropbox.com/s/mh49vwvue47au8a/SSH.Config.Editor.v2.3.2.dmg.zip?dl=1"
