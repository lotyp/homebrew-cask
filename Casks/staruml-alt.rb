cask "staruml" do
  ...
  if Hardware::CPU.intel?
    url "https://www.dropbox.com/s/1lzdedndoy4uqf1/StarUML.#{version}.amd64.dmg.zip?dl=0",
        referer: "https://www.dropbox.com/s/1lzdedndoy4uqf1/StarUML.#{version}.amd64.dmg.zip?dl=0"
  else
    url "https://www.dropbox.com/s/jp2u4lzwckm85si/StarUML.#{version}.arm64.dmg.zip?dl=0",
        referer: "https://www.dropbox.com/s/jp2u4lzwckm85si/StarUML.#{version}.arm64.dmg.zip?dl=0"
  end
